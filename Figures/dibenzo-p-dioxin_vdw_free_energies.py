...
ax[0].annotate('scaling', xy=(0.1, 0.5), xycoords='axes fraction', rotation=40)
ax[0].annotate('softcore', xy=(0.2, 0.2), xycoords='axes fraction', rotation=25)
